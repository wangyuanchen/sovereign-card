...
interface ProfileContentProps {
  ...
  ensData: { name: string | null; avatar: string | null };
  profileData: {
    nfts: unknown;
    tokens: unknown;
        ...
        <nav className="flex items-center justify-between mb-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold">{tc("sovereignCard")}</span>
            </div>
          </div>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <section className="card-section lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-semibold">{t("nftCollection")}</h2>
            </div>
          ...
          <section className="card-section">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-semibold">{t("tokenHoldings")}</h2>
            </div>
          ...
          <section className="card-section">
            ...
            <ActivityFeed
              transactions={profileData.transactions as any}
